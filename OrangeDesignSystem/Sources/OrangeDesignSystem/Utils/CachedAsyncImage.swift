...
/*
 This particular file is licensed under MIT,
 was picked from [GitHub](https://github.com/lorenzofiamingo/swiftui-cached-async-image/tree/main)
 under copyright (c) 2021 Lorenzo Fiamingo
 */
...
/// instance to load an image from the specified URL, and then displays it.
/// For example, you can display an icon that's stored somewhere in the web:
///
...
// ===================================
// MARK: - URL Session Task Controller
// ===================================
