...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/tevelee/SwiftUI-Flow", .exact("3.0.2")),
        .package(url: "https://github.com/lucaszischka/BottomSheet", .exact("3.1.1")),
        .package(url: "https://github.com/Orange-OpenSource/accessibility-statement-lib-ios.git", .exact("1.3.0"))
    ],
    targets: [
        .target(
            name: "OrangeDesignSystem",
