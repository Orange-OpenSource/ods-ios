...
## [1.4.0](https://github.com/Orange-OpenSource/ods-ios/compare/1.2.0...1.4.0) - 2025-06-04

### Changed

- [DemoApp/SDK] Sunset ODS (doc, demo app, warnings in SDK)
- [Tooling] Update pod `SwiftFormat/CLI` from v0.56.1 to v0.56.2
